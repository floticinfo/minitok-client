...
export function inspectArtifacts() {
  ...
  return { errors, status: errors.length ? "missing" : authoritative.status, metadata: { source: "git worktree", npm: { name: packageJson.name, version: packageJson.version }, extension: { name: extensionJson.name, version: extensionJson.version }, authoritative, stale } };
}
